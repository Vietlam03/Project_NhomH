			...
			<?php for ($i = 0; $i < 3; $i++) { ?>
				...
				<div class="col-md-4 col-xs-6">
					<div class="shop">
						...
						<div class="shop-body">
							<h3><?php echo $allmanus[$i]->manu_name ?><br></h3>
							<a href="{{ url('/store') }}" class="cta-btn">Mua Ngay <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
				</div>
				<!-- /shop -->
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="section-title">
					<h3 class="title">New Pizza Matter</h3>
											...
											<form action="{{ url('/others/index/'.$value->product_id.'/0') }}" method="get">
												<div class="product-btns">
													...
													<?php if (session()->has('compare' . $value->product_id)) { ?>
														<button name="action" value="compare" class="add-to-compare"><i style="color:green;" class="fa fa-exchange"></i><span class="tooltipp">add to compare</span></button>
													<?php } else { ?>
												...
												<div class="product-btns">
													...
													foreach ($user->others as $other) {
														if ($other->product_id == $value->product_id && $other->like == "1") {
															$like = 1; ?>
															<button name="action" value="wishlist" class="add-to-wishlist"><i style="color:green;" class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
														<?php }
													}
													if ($like == 0) { ?>
														<button name="action" value="wishlist" class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="hot-deal">
					...
					<h2 class="text-uppercase">Khuyến Mãi Hấp dẫn</h2>
					<p>Giảm 50% cho tất cả sản phẩm</p>
